...
function AuthCallbackPage() {
  ...
  if (error) return (
    <div data-testid="auth-callback-error" className="max-w-md mx-auto py-20 text-center space-y-4">
  ...
  return (
    <div className="flex items-center justify-center min-h-screen">
      <div data-testid="auth-callback-pending" className="flex items-center gap-3 text-muted-foreground">
