/*
 * journey/seo-smoke.mjs — the public-surface smoke gate (JRNY-11).
 *
 * RESTORED 2026-08-10 by the H1 hardening loop under owner delegation. cut(04)
 * (4ccf06270) deleted this file with the fourteen marketing routes it drove,
 * but G21 stayed registered in gates.manifest.json and its lock entry may not
 * be removed. The command string is unchanged; the route list is now the
 * committed post-cut public surface (seo-routes.json: / and /auth).
 *
 ...
 *
 * "No 404" is implemented as the stronger, checkable thing: no response fetched while loading the route may
