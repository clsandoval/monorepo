...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex w-full items-center bg-transparent border-b border-border rounded-none p-0 h-auto",
        className
      )}
      {...props}
    />
