...
| [frontend/docs-pages.md](frontend/docs-pages.md) | Docs layout (260px sidebar, DocsTopbar, 780px article, full typography + callout box system); Quick Start guide (8 numbered steps: account creation → Discord bot setup → Anthropic API key → add key to Daimon → connect Discord → verify live → first message → optional integrations); Troubleshooting section; What's Next; Discord & Core Tools tool reference (Discord 7, Dub 2, Credentials 1, GitHub 1); Toggl tool reference (34 tools in 6 categories); LinkedIn & Google Analytics tool reference (LinkedIn 17 + Google Analytics 4); Fly, ACP, Decision Hub, Onyx & Bluedot tool reference (23 tools); Linear tool reference (6 remote MCP tools: linear_list_issues, linear_search_issues, linear_get_issue, linear_create_issue, linear_update_issue, linear_list_teams — each with full params, example output, error cases; Remote MCP architecture note; "Setting Up Linear" walkthrough; Complete Tool Index 90 tools); FAQ page (42 questions across 7 sections: Billing & Pricing 10, Security 6, Bot Setup & Discord 8, Integrations & Tools 6, Troubleshooting 7, Limits & Quotas 5, Account & Teams 6; accordion spec with details/summary HTML; all-open-by-default; accessibility 7 ARIA specs); billing doc page pending (4.8h). | Partial (4.8a–4.8g done) |
