...
| [frontend/component-library.md](frontend/component-library.md) | Layout components: DashboardLayout, Sidebar (NavItem, SidebarFooter), DashboardTopbar (PlanBadge), MobileNav, AuthLayout, AuthCard, AuthLogo, AuthFooterLinks, PageShell, PublicNavbar (PublicMobileMenu), PublicFooter, PublicLayout, AdminLayout — all with TypeScript props interfaces, exact dimensions/colors/typography, all interaction states | Partial (4.9a done; 4.9b–4.9e pending) |
