#!/bin/bash
# Ralph Loop — Filipino Youth Slang Dictionary & Thesaurus
# Gathers slang from PH rap lyrics + social media, defines, builds thesaurus.
#
# Usage: cd loops/ph-youth-slang-reverse && ./loop.sh [max_iterations]
