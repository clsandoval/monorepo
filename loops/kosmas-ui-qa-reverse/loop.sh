#!/bin/bash
# Ralph Loop — Kosmas UI Treatment Deck Mobile QA
# Audits the Kosmas UI treatment deck HTML across 5 viewports
# using Playwright screenshots + CSS code analysis.
# Produces a prioritized QA findings report.
#
# Usage: cd loops/kosmas-ui-qa-reverse && ./loop.sh [max_iterations]
