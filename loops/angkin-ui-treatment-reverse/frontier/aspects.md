...
- [ ] 1.1 — Audit TaxKlaro current design tokens: read `apps/taxklaro/frontend/src/index.css` and extract all CSS variables, colors, fonts, spacing
...
- [ ] 4.1 — Angkin platform home: tool grid, nav, hero, footer. Desktop 1280px.
- [ ] 4.2 — TaxKlaro landing page: hero, features, CTA. Desktop 1280px.
