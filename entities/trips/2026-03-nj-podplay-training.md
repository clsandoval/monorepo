...
people: [[Stan Wu]], [[PodPlay ops team]], [[Nico]], [[Marco Basug]]
...
- Carlos Sandoval and [[Marco Basug]] traveling together
- Primary trainer: [[Nico]] (hardware/replay service)
- Also meeting: [[Andy]] (project manager — specs, kickoff), [[PodPlay ops team]] (head of ops — account decisions)
...
- Payment integration (Stripe alternative) already being handled by PodPlay dev team
...
- [ ] Contact info for technical support (Stan Wu, PodPlay ops team, Nico)
