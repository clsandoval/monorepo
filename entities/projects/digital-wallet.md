...
- [[Marcello]] given a payment instance, currently acting as "Cosmos" (merchant/platform role) for testing
...
- Open question: venue-locked vs cross-venue credits — need confirmation from the team and padel partners
