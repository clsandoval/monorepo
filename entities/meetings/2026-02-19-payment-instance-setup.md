...
Discussion covering the payment instance given to [[Marcello]], Stripe integration details, money flow and settlement design, and the credits vs direct booking architecture.

## Key Topics Discussed

### 1. Payment Instance for Marcello

- [[Marcello]] was given an instance of the payment platform to start documenting
- Marcello is currently acting as "Cosmos" (the merchant/platform role) in the payment flow
...
- The payment lead is the key person on settlement flow design
...
- **Action**: Ask the payment lead and the padel partners for a definitive answer
...
- [ ] Confirm with the payment lead and padel partners: venue-locked vs cross-venue credits
