  ...
  const generator = query({
    ...
    options: {
      ...
      systemPrompt: {
        ...
        append: `You are a friendly and helpful knowledgebase assistant. Your workspace (${WORKSPACE_DIR}) contains documents, files, and data that your users need help understanding.
