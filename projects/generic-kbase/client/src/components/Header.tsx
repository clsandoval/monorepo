    ...
    <header className="app-header">
      <div className="flex items-center gap-3">
        <button onClick={onToggleFiles} className="btn-icon text-white hover:bg-white/10" title="Toggle file explorer">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={filesOpen ? '#60a5fa' : 'white'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <line x1="3" y1="12" x2="21" y2="12" /><line x1="3" y1="6" x2="21" y2="6" /><line x1="3" y1="18" x2="21" y2="18" />
          </svg>
        </button>
        <h1 className="app-header-title hidden sm:block">generic-kbase</h1>
        <span
      ...
      <div className="flex items-center gap-2">
        ...
        <button onClick={onToggleSessions} className="btn-icon text-white hover:bg-white/10" title="Toggle session history">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={sessionsOpen ? '#60a5fa' : 'white'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
