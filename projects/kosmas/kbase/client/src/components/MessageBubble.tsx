...
export function MessageBubble({ message }: MessageBubbleProps) {
  ...
  if (message.role === 'error') {
    return (
      <div className="flex justify-start mb-2">
        <div className="max-w-prose rounded-lg px-4 py-3 border animate-fade-in-up" style={{ background: 'rgba(196, 74, 58, 0.08)', borderColor: 'rgba(196, 74, 58, 0.24)' }}>
  ...
  return (
    <div className="flex justify-start mb-2 animate-fade-in-up">
      <div className="max-w-full md:max-w-prose rounded-lg px-3 md:px-4 py-2 md:py-3 border border-default overflow-hidden" style={{ background: 'rgba(214, 126, 75, 0.06)' }}>
