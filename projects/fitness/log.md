...
- **Trained:** steps push (count not given), no lifting
- **Notes (evening update):** **+1 Krispy Kreme original glazed ~190/3g [label], and he's done eating solid.** Day closes at **~1950 / ~89g** with a **71g protein hole and ~50 cal to the ceiling** — the hole can only close over the ceiling. Call: **David's bar (~150/28g) + 2 scoops in water (~280/48g) → ~2380 / ~165g, ~167g carbs.** Floor cleared, 380 over the ceiling, still a ~320 deficit at a ~2700 TDEE. Bar first is correct — 5.4 cal per gram of protein vs the scoop's 5.8. **The discouragement is aimed at the wrong number.** 96.5 is water (see below) but the month is the real story: 7/03 96.4 → 8/01 95.5 is **~0.9 kg in 30 days**, against a model that predicted ~3. The gap isn't the plan failing, it's compliance drifting on one axis: **7/28 2185 · 8/01 ~2615–2805 · 8/02 ~2380, plus unlogged days charged at ~3300.** He's hitting the protein floor (164g, 165g) and missing the calorie ceiling — and the ceiling is the only lever that moves fat. Protein protects muscle; it does not create a deficit. **~15k steps buys ~250–350 cal** — real, but it cannot absorb a 600-cal restaurant round. Nothing is broken and nothing needs to get harder: hold the exact same protein discipline and put it *under* 2000 instead of on top of it.
