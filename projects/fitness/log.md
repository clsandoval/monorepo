...
- **Trained:** 10k steps, no lifting
- **Notes (evening update):** **+1 Krispy Kreme original glazed ~190/3g [label], and he's done eating solid.** Day closes at **~1950 / ~89g**. **Scored under the revised targets set today (2200/2500 ceiling · 145 floor — see profile):** 10k steps is his baseline, not an earned day (the ×1.4 TDEE multiplier already assumes ~that), so **the live ceiling is 2200** — ~250 cal of room against a 56g protein hole. Nothing closes that inside the ceiling, so floor beats ceiling and the only question is by how little. Call: **2 scoops (~280/48g) + 100g cottage cheese (~82/12g) → ~2310 / ~149g.** Floor cleared, 110 over the ceiling, ~400 deficit at a ~2700 TDEE — a good day. (The earlier David's-bar + 2-scoop call was sized for the retired 160 floor: ~2380/165g, 180 over. Fine as the fallback if there's no cottage cheese — not worth a trip out for 70 cal.) **The discouragement is aimed at the wrong number.** 96.5 is water (see below) but the month is the real story: 7/03 96.4 → 8/01 95.5 is **~0.9 kg in 30 days**, against a model that predicted ~3. The gap isn't the plan failing, it's compliance drifting on one axis: **7/28 2185 · 8/01 ~2615–2805 · 8/02 ~2380, plus unlogged days charged at ~3300.** He's hitting the protein floor (164g, 165g) and missing the calorie ceiling — and the ceiling is the only lever that moves fat. Protein protects muscle; it does not create a deficit. **~15k steps buys ~250–350 cal** — real, but it cannot absorb a 600-cal restaurant round. Nothing is broken and nothing needs to get harder: hold the exact same protein discipline and put it *under* 2000 instead of on top of it.
- **Notes:** **96.5 is +1.0 off yesterday and it's water, not fat.** 2–3 L of coconut water yesterday is 2–3 kg of fluid in transit plus ~180–270g of sugar driving glycogen + its bound water; coconut water is potassium-heavy and sodium-light, so the retention reads high on the scale and low in the tank. Discount this number, re-weigh in 2 days. **It does mean 8/01 was under-logged:** I recorded 1 L coconut water (~190 cal) — at 2–3 L that's another ~190–380 cal, so 8/01 actually closed ~2615–2805, i.e. roughly maintenance at a ~2700 TDEE, not the ~275–600 deficit I called. Second soft day in a row is the thing to watch, not the scale. **Today: ~240 cal to the ceiling with a 74g protein hole** — that gap only closes with near-pure protein. Call: **3 scoops in water (~420/72g) → ~2180 / ~158g.** 180 over the ceiling, 2g shy of the floor, and floor beats ceiling — take it and eat nothing solid after. Still a ~520 deficit at TDEE. The cake + rice + tortillas were ~530 cal for 8g; the lechon was the day's real cost (470 for 28g = 16.8 cal/g). Lean protein tomorrow, and if lightheaded after all that low-sodium fluid, salt the food.
